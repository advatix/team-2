export const environment = {
  production: false,
  BASEURL : 'https://felep.xpdel.com/',
  WEBSERVICE_URL:'https://felep.xpdel.com/fep/api/v1',
  WEBSERVICE_REPORTS_URL:'https://felep.xpdel.com/',
  // WEBSERVICE_URL:'https://cocktailkingdom.advatix.net/fep/api/v1',
  BASE_URL : "/fep/",
  PAGE_SIZE:10,
  envName: 'felep',
  keycloak: {
